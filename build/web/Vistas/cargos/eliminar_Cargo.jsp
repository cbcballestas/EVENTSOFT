...
<html>
    ...
    try {
          ...
          RequestDispatcher a = request.getRequestDispatcher("Cargos.jsp?respuesta_eliminacion=Cargo " +"eliminado exitosamente");
			a.forward(request, response);
          %>
          <%
       }catch(SQLException e){
           RequestDispatcher a = request.getRequestDispatcher("Cargos.jsp?error_eliminacion=Error al " +"eliminar cargo");
			a.forward(request, response);
        %>
