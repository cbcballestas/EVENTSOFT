...
<head>
    ...
    <title>::Aplicativo web para la gesti&oacute;n de eventos:: Gesti&oacute;n de clientes</title>
        ...
        <nav class="navbar navbar-inverse navbar-fixed-top" role="navigation">
            ...
            <div class="collapse navbar-collapse navbar-ex1-collapse">
                <ul class="nav navbar-nav side-nav">
                    ...
                    <li>
                        <a href="Cliente.jsp"><i class="fa fa-fw fa-users"></i>Clientes</a>
                    </li>
                    <li>
  ...
  <div class="panel panel-default">
    <div class="panel-heading" role="tab" id="headingOne">
      ...
      <div align="left" class="panel-body">
          <form action="registro_Cliente.jsp" method="POST" id="formulario_cliente">
          <label>Identificaci&oacute;n:<font color="red"><b>*</b></font></label>
          <input type="text" name="identificacion" required class="form-control" placeholder="Identificacion" />
          <label>Nombres:<font color="red"><b>*</b></font></label>
          <input type="text" name="nombres" required class="form-control" placeholder="Nombres" />
          <label>Apellidos:<font color="red"><b>*</b></font></label>
          <input type="text" name="apellidos" required class="form-control" placeholder="Apellidos" />
          <label>Tel&eacute;fono(s):<font color="red"><b>*</b></font></label>
          <input type="text"  maxlength="6" name="telefono" required class="form-control" placeholder="Telefono" />
          <label>Celular:<font color="red"><b>*</b></font></label>
          <input type="text"  name="celular" required class="form-control" placeholder="Ingrese telefono" />
          <label>Ciudad:<font color="red"><b>*</b></font></label>
          <input type="text" name="ciudad" required class="form-control" placeholder="Ciudad" />
          ...
          <br>
          <input type="submit" value="REGISTRAR CLIENTE" class="btn btn-primary" id="btn_guardar_cliente"/><br>
          <p style="color: red; font-weight: bold">*Datos obligatorios</p>
          </form>
      </div>
      </div>
       </div>           
...
<tr>
  <td colspan="1">Identificacion </td>
  <td colspan="1">Nombres </td>
  <td colspan="1">Apellidos</td>
  <td colspan="1">Tel&eacute;fono</td>
  ...
  <td colspan="2">Acci&oacute;n</td>
    ...
    try {
          ...
          while( rs.next()  ){
              %>
  <tr>
  <td rowspan="1"> <%= rs.getInt("identificacion")  %>  </td>
  <td rowspan="1"><%= rs.getString("nombre")  %>  </td>
  <td rowspan="1"><%= rs.getString("apellidos")  %>  </td>
  <td rowspan="1"><%= rs.getString("telefono")  %>  </td>
  <td rowspan="1"><%= rs.getString("celular")  %>  </td>
  <td rowspan="1"><%= rs.getString("ciudad")  %>  </td>
  <td rowspan="1"><%= rs.getString("direccion")  %>  </td>
  <td rowspan="1"><%= rs.getString("email")  %>  </td>
  <td><a class="btn btn-warning" target="_self" href="#">Editar</a></td>
  <td><a class="btn btn-danger" href="eliminar_Cliente.jsp?cod=<%=rs.getInt("identificacion")%>">Eliminar</a></td>
	</tr>
<%
          }
