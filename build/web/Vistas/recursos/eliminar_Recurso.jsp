...
<html>
    ...
    try {
          ...
          RequestDispatcher a = request.getRequestDispatcher("Recurso.jsp?respuesta_eliminacion=Recurso " +"eliminado exitosamente");
          ...
          //out.println("Cliente guardado exitosamente");
           ...
           RequestDispatcher a = request.getRequestDispatcher("Recurso.jsp?error_eliminacion=Error al " +"eliminar recurso");
			a.forward(request, response);
        %>
        <%--<jsp:forward page="Cliente.jsp">
